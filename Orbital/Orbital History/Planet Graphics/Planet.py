...
for n in range(10):
    if (n>=1):
        w[n]=w[n-1]+random.randint(1000,2000)
        h[n]=h[n-1]+random.randint(-100,100)
    spin.append(n); spin[n]=random.randint(-300,300)/100000
