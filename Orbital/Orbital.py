...
hot1=pygame.image.load("Images/hot1.png").convert_alpha()
hot2=pygame.image.load("Images/hot2.png").convert_alpha()
cold1=pygame.image.load("Images/cold1.png").convert_alpha()
cold2=pygame.image.load("Images/cold2.png").convert_alpha()
circle=pygame.image.load("Images/circle.png").convert_alpha()
blue_sky=pygame.image.load("Images/blue_sky.png").convert_alpha()
blue_sky2=pygame.image.load("Images/blue_sky2.png").convert_alpha()
sunlight=pygame.image.load("Images/sunlight.png").convert()
background=pygame.image.load("Images/background.png").convert_alpha()
arrow=pygame.image.load("Images/arrow.png").convert_alpha()
thrusters=pygame.mixer.Sound("Images/thrusters.wav")
...
while mainloop:
    ...
    pygame.display.set_caption("FPS: "+str(int(Clock.get_fps()))+" - Press r to Reset Anytime - Created by: Alex Elson in Python+Pygame")
    pygame.display.flip()
